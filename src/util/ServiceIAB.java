...
import static vinoos.cordova.iap.util.IabHelper.IABHELPER_MISSING_TOKEN;
import static vinoos.cordova.iap.util.IabHelper.IABHELPER_REMOTE_EXCEPTION;
import static vinoos.cordova.iap.util.IabHelper.IABHELPER_SEND_INTENT_FAILED;
import static vinoos.cordova.iap.util.IabHelper.IABHELPER_SUBSCRIPTIONS_NOT_AVAILABLE;
import static vinoos.cordova.iap.util.IabHelper.ITEM_TYPE_INAPP;
import static vinoos.cordova.iap.util.IabHelper.ITEM_TYPE_SUBS;
import static vinoos.cordova.iap.util.IabHelper.RESPONSE_BUY_INTENT;
...
public class ServiceIAB extends IAB {
    ...
    ServiceIAB(IABLogger logger, int market) {
        super(logger);
    	mMarket = market;
