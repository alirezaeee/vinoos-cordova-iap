...
import vinoos.cordova.iap.util.communication.BillingSupportCommunication;
import vinoos.cordova.iap.util.communication.OnConnectListener;
import org.json.JSONException;
import static vinoos.cordova.iap.util.IabHelper.BILLING_RESPONSE_RESULT_OK;
import static vinoos.cordova.iap.util.IabHelper.IABHELPER_BAD_RESPONSE;
import static vinoos.cordova.iap.util.IabHelper.IABHELPER_UNKNOWN_ERROR;
import static vinoos.cordova.iap.util.IabHelper.IABHELPER_UNKNOWN_PURCHASE_RESPONSE;
import static vinoos.cordova.iap.util.IabHelper.IABHELPER_USER_CANCELLED;
import static vinoos.cordova.iap.util.IabHelper.IABHELPER_VERIFICATION_FAILED;
import static vinoos.cordova.iap.util.IabHelper.RESPONSE_CODE;
import static vinoos.cordova.iap.util.IabHelper.RESPONSE_INAPP_PURCHASE_DATA;
import static vinoos.cordova.iap.util.IabHelper.RESPONSE_INAPP_SIGNATURE;
import static vinoos.cordova.iap.util.IabHelper.getResponseDesc;
